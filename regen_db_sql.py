...
db_sql = {
    ...
    "questions": [
        ...
        {"id": "db_sql_006", "question": "相関サブクエリの特徴として最も適切なものはどれか。", "choices": ["外部参照しない", "外部クエリの各行に対して内部クエリ実行", "性能優れている", "JOINより高速"], "answer": 1, "explanation": "相関サブクエリ：外部クエリ各行に対して内部クエリ実行。低性能のため、JOI置き換え推奨。"},
...
try:
    with open(r"C:\git\waos\exam-questions\data\db\questions_db_sql.json", 'w', encoding='utf-8') as f:
        json.dump(db_sql, f, ensure_ascii=False, indent=2)
    print("OK: db_sql")
